...
class Config():
    ...
    def __init__(self):
        ...
        self.robot_radius = AllConstants.ROBOT_RADIUS  # [m]
...
start = AllConstants.start_state[0]
start_State = AllConstants.start_state
goal = AllConstants.goal_state[0]
goal_State = AllConstants.goal_state
...
goal = np.array(AllConstants.goal_state[0])
...
for i in range(1000):
    ...
    if dist(traj[-1][0:2], goal) < AllConstants.ROBOT_RADIUS:
        print ("!!!!!!!!!!END DWA")
        break
